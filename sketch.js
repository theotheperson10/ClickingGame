...
storeItem("value",str(value))}
  if(screen=="shop"){
sprites=changeText(sprites,35,100,4,"Cost: "+multi*multi*25)
    sprites=changeText(sprites,35,200,4,"Cost: "+auto*auto*50)
    sprites=changeText(sprites,35,300,4,"Cost: "+value*value*25)
  }
...
[35,100,4,"Cost: 1","text",[0,0,0]],[35,200,4,"Cost: 1","text",[0,0,0]],[35,300,4,"Cost: 1","text",[0,0,0]]]
}else{
screen="home";
sprites=[
